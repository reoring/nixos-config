...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "reoring"
    user-mail-address "reoring@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/reoring/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/reoring/bin" "/profile/bin" "/Users/reoring/.npm-packages/bin" "/Users/reoring/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
